...
import { CallToAction } from 'gatsby-theme-contentful/src/components/Section/CallToAction';
...
Even with third party tools such as <ExternalLink>Material-UI</ExternalLink> or <ExternalLink>TailwindCSS </ExternalLink>
...
Storybook has some great documentation for configuration with many different JavaScript projects <ExternalLink>Storbybook</ExternalLink>

One configuration that is missing is integrating Storybook into GatsbyJS with TailwindCSS support<ExternalLink>Learn more about Gatsby </ExternalLink>and <ExternalLink>TailwindCSS </ExternalLink>
